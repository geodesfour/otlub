<?php
function startkit_preprocess_page(&$vars, $hook) {
...
function startkit_bootstrap_search_form_wrapper($variables) {
 ...
 */
/*function startkit_nodeapi(&$node, $op, $a3 = NULL, $a4 = NULL) {
...
/*function startkit_custom_breadcrumb(){
  $ret = array(
    l(t('Home'), NULL),
    l(t('Example'), 'example'),
 ...
 */
/*function startkit_page_delivery_callback_alter(&$callback) {
